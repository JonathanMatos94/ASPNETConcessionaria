        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Placa = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Opcionais = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataUltimoAumento = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ImagemUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NegociacaoId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Negociacao = table.Column<int>(type: "int", nullable: false),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    VeiculoId = table.Column<int>(type: "int", nullable: false),
                    SaldoTotal = table.Column<decimal>(type: "decimal(20,2)", nullable: false),
                    SaldoVendas = table.Column<decimal>(type: "decimal(20,2)", nullable: false),
                    SaldoCompras = table.Column<decimal>(type: "decimal(20,2)", nullable: false),
                    DataNegociacao = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Negociacoes", x => x.NegociacaoId);
                    table.ForeignKey(
                        name: "FK_Negociacoes_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "ClienteId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Negociacoes_Veiculos_VeiculoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Negociacoes_ClienteId",
                table: "Negociacoes",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_Negociacoes_VeiculoId",
                table: "Negociacoes",
                column: "VeiculoId");
        }
